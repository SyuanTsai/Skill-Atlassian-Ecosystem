...
if ($inventory.sourceId -isnot [string] -or [string]$inventory.sourceId -cne 'atlassian-ecosystem') {
    throw "catalog/source.json sourceId must be exact string 'atlassian-ecosystem'."
}
if ($inventory.repository -isnot [string] -or [string]$inventory.repository -cne 'https://github.com/SyuanTsai/Skill-Atlassian-Ecosystem.git') {
